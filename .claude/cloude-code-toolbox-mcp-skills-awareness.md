...
_Generated: 2026-08-04T13:26:40.684Z_
...
Workspace `mcp.json` _(folder: POS project)_

- **c:\POS project\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\WINDOWS 10\.claude.json** — _File missing_
